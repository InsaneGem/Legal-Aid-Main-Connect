...
// //   PlayCircle, StopCircle, MoreVertical, Mic, Lock
// // } from 'lucide-react';
...
//     const messageChannel = supabase.channel(`messages-${id}`)
//       .on('postgres_changes', {
//         event: 'INSERT',
//         schema: 'public',
//         table: 'messages',
...
//         setConsultation(payload.new as ConsultationDetails)
...
//           <div className="p-6 mt-auto space-y-2 border-t">
...
//                   <div key={m.id} className={`flex ${isOwn ? 'justify-end' : ''}`}>
